...
function initialize_add_page() {
    if ($("#veresedaki_datefield").attr('edited') == undefined)
...
function update_veresedaki_sliders() {
    ...
    // $('.veresedaki_participant_slider').slider('refresh');
    $('.veresedaki_participant_slider').html(sum_value);
}
...
function reset_veresedaki_date() {
    ...
    $('#veresedaki_datefield').attr('edited', 'true');
...
$(document).ready(function() {
			  ...
			  function() {
			      ...
			      $("#veresedaki_datefield").removeAttr('edited');
			      $("#peoplelist").empty();
			      reset_veresedaki_date();
			  });
