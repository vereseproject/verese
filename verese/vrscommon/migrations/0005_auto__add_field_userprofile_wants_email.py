...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.wants_email'
        db.add_column('vrscommon_userprofile', 'wants_email', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.wants_email'
        db.delete_column('vrscommon_userprofile', 'wants_email')
