...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VeresedakiStatus.veresedaki'
        db.add_column('vrscommon_veresedakistatus', 'veresedaki', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vrscommon.Veresedaki']), keep_default=False)

        # Deleting field 'Veresedaki.status'
        db.delete_column('vrscommon_veresedaki', 'status_id')


    def backwards(self, orm):
        
        # Deleting field 'VeresedakiStatus.veresedaki'
        db.delete_column('vrscommon_veresedakistatus', 'veresedaki_id')

        # Adding field 'Veresedaki.status'
        db.add_column('vrscommon_veresedaki', 'status', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vrscommon.VeresedakiStatus'], unique=True, null=True, blank=True), keep_default=False)
