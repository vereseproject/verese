...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Relation', fields ['user2', 'user1']
        db.create_unique('vrscommon_relation', ['user2_id', 'user1_id'])

        # Changing field 'UserProfile.user'
        db.alter_column('vrscommon_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Relation', fields ['user2', 'user1']
        db.delete_unique('vrscommon_relation', ['user2_id', 'user1_id'])

        # Changing field 'UserProfile.user'
        db.alter_column('vrscommon_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
