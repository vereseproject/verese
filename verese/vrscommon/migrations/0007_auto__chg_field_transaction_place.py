...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.place'
        db.alter_column('vrscommon_transaction', 'place', self.gf('django.db.models.fields.CharField')(max_length='200', null=True))


    def backwards(self, orm):
        
        # Changing field 'Transaction.place'
        db.alter_column('vrscommon_transaction', 'place', self.gf('django.db.models.fields.TextField')(null=True))
