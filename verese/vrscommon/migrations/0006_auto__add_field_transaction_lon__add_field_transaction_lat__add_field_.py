...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.lon'
        db.add_column('vrscommon_transaction', 'lon', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.lat'
        db.add_column('vrscommon_transaction', 'lat', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.place'
        db.add_column('vrscommon_transaction', 'place', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.lon'
        db.delete_column('vrscommon_transaction', 'lon')

        # Deleting field 'Transaction.lat'
        db.delete_column('vrscommon_transaction', 'lat')

        # Deleting field 'Transaction.place'
        db.delete_column('vrscommon_transaction', 'place')
    ...
    models = {
        ...
        'vrscommon.veresedaki': {
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vrscommon.Transaction']"})
        },
        'vrscommon.veresedakistatus': {
            'Meta': {'ordering': "['-created']", 'unique_together': "(('veresedaki', 'status', 'user'),)", 'object_name': 'VeresedakiStatus'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '30', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'veresedaki': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vrscommon.Veresedaki']"})
        }
    }
