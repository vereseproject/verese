...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Veresedaki.local_amount'
        db.add_column('vrscommon_veresedaki', 'local_amount', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=7, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Veresedaki.local_amount'
        db.delete_column('vrscommon_veresedaki', 'local_amount')
