...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vrscommon_currency', 'code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Currency.rate'
        db.alter_column('vrscommon_currency', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=5))


    def backwards(self, orm):
        
        # Changing field 'Currency.code'
        db.alter_column('vrscommon_currency', 'code', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'Currency.rate'
        db.alter_column('vrscommon_currency', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4))
    ...
    models = {
        ...
        'vrscommon.veresedaki': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vrscommon.VeresedakiStatus']", 'blank': 'True'})
        },
        'vrscommon.veresedakistatus': {
            'Meta': {'object_name': 'VeresedakiStatus'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '20', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }
