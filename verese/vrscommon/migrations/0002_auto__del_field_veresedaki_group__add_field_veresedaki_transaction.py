...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Veresedaki.group'
        db.delete_column('vrscommon_veresedaki', 'group_id')

        # Adding field 'Veresedaki.transaction'
        db.add_column('vrscommon_veresedaki', 'transaction', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vrscommon.Transaction']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Veresedaki.group'
        db.add_column('vrscommon_veresedaki', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vrscommon.Transaction']), keep_default=False)

        # Deleting field 'Veresedaki.transaction'
        db.delete_column('vrscommon_veresedaki', 'transaction_id')
