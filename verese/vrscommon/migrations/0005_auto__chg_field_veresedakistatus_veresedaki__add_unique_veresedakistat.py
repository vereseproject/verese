...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Currency.image'
        db.add_column('vrscommon_currency', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VeresedakiStatus.veresedaki'
        db.alter_column('vrscommon_veresedakistatus', 'veresedaki_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vrscommon.Veresedaki'], null=True))

        # Deleting field 'Currency.image'
        db.delete_column('vrscommon_currency', 'image')
